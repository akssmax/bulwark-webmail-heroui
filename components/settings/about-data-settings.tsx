...
function VersionUpdateTag() {
  ...
  return (
    <span
      className={cn(
        "ms-2 inline-flex items-center rounded-full px-1.5 py-0.5 text-xs font-medium align-middle",
        important
    ...
    <>
      ...
      <div className="rounded-lg border border-border bg-card p-5 mb-6">
        <div className="flex items-center gap-4">
          <Button variant="ghost" onClick={handleLogoClick} className="flex items-center gap-4 flex-1 text-start h-auto min-h-0 px-0 py-0 justify-start font-normal group/about" aria-label="About">
